...
Do not open a public issue for a suspected vulnerability. Report it privately through GitHub's **Security → Report a vulnerability** flow for `endless-net/stun`, including affected versions, reproduction details, impact, and any suggested mitigation.
